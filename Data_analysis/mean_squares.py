...
data_1_norm = [(10*30)/float(i) for i in data_1[:-1]]
data_2_norm = [(10*30)/float(i) for i in data_2[:-1]]
data_3_norm = [(10*30)/float(i) for i in data_3[:-1]]
data_4_norm = [(10*30)/float(i) for i in data_4[:-1]]
data_5_norm = [(10*30)/float(i) for i in data_5[:-1]]
...
ax.set_title('Mean squares metric analysis')
