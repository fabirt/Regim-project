...
data_1_norm = [float(i)*10/-1.4 for i in data_1[:-1]]
data_2_norm = [float(i)*10/-1.4 for i in data_2[:-1]]
data_3_norm = [float(i)*10/-1.4 for i in data_3[:-1]]
data_4_norm = [float(i)*10/-1.4 for i in data_4[:-1]]
data_5_norm = [float(i)*10/-1.4 for i in data_5[:-1]]
...
ax.set_title('Mutual information metric analysis')
