...
def openFile():
    ...
    try:
        ...
        myLabel.configure(image=tkImage)
...
# Add title
win.title("REGIM")
win.geometry("450x550+0+0")

# Change icon
#win.iconbitmap('images/ico11.ico')
...
myLabel = Label(win, image=None, text="Load image.jpg", width=18, height=10, font=("Verdana", 30))
